...
Heartbeat.prototype.start = function() {
  this.senderId = setInterval(this.sendHeartbeat.bind(this), HEARTBEAT_INTERVAL);
  this.verifyId = setInterval(this.verifyHeartbeats.bind(this), TIMEOUT_INTERVAL);
  this.senderId.unref();
  this.verifyId.unref();
  return Q();
};
...
Heartbeat.prototype.stop = function() {
  clearInterval(this.senderId);
  clearInterval(this.verifyId);
  this.heartbeats = {};
  return Q();
};
