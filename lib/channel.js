...
function Channel(cluster) {
  ...
  this.protocols.on('message', Channel.prototype.onMessage.bind(this));
  this.protocols.on('viewChanged', Channel.prototype.onViewChanged.bind(this));
  this.protocols.on('memberAdded', Channel.prototype.onMemberAdded.bind(this));
  this.protocols.on('memberRemoved', Channel.prototype.onMemberRemoved.bind(this));
}
 ...
 */
Channel.prototype.viewChanged = function(view) {
